...
# from chemtrain.traj_util import trajectory_generator_init
from chemtrain.util import MLETrainerTemplate, TrainerState
import chemtrain.jax_md_mod.dropout_nn_util


@partial(dataclass, frozen=True)
class DifftreState(TrainerState):
    traj_state: Any
...
def init_trajectory_with_energy(simulator_template, energy_fn_template,
    ...
    """
    trajectory_generator = chemtrain.traj_util.trajectory_generator_init(simulator_template,
                                                     energy_fn_template,
                                                     neighbor_fn,
                                                     timings_struct)
