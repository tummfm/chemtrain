...
def plot_initial_and_predicted_rdf(rdf_bin_centers, g_average_final, model,
                                   ...
                                   std=None, T=None,  outdir="./figures"):
    ...
    plt.savefig(f'{outdir}/predicted_RDF_'
...
def plot_initial_and_predicted_adf(adf_bin_centers, predicted_adf_final, model,
    ...
    plt.savefig(f'{outdir}/predicted_ADF_'
                f'{model}_{T or ""}_{visible_device}{pretrain_str}.png')
    return
...
def plot_initial_and_predicted_tcf(bin_centers, g_average_final, model,
                                   ...
                                   axis_label=None, outdir="./figures"):
    if labels is None:
    ...
    if transparent:
        plt.savefig(f'{outdir}/predicted_TCF_' + model + '.png',
                    transparent=True)
    else:
        plt.savefig(f'{outdir}/predicted_TCF_' + model + '.png')
    return
...
def plot_pressure_history(pressure_history, model, visible_device,
                          reference_pressure=None,  outdir="./figures"):
    ...
    ax1.legend()
    plt.savefig(f'{outdir}/difftre_pressure_history_' + model + str(visible_device) + '.png')
    return

def plot_density_history(density_history, model, visible_device, reference_density=None,  outdir="./figures"):
    fig, ax1 = plt.subplots()
    ax1.set_xlabel('update step')
    ...
    ax1.legend()
    plt.savefig(f'{outdir}/difftre_density_history_' + model + str(visible_device) + '.png')
    return

def plot_alpha_history(prediction_history, model, visible_device, reference=None,  outdir="./figures"):
    fig, ax1 = plt.subplots()
    ax1.set_xlabel('update step')
    ...
    ax1.legend()
    plt.savefig(f'{outdir}/difftre_alpha_history_' + model + str(visible_device) + '.png')
    return

def plot_kappa_history(prediction_history, model, visible_device, reference=None,  outdir="./figures"):
    fig, ax1 = plt.subplots()
    ax1.set_xlabel('update step')
    ...
    if reference is not None:
        ax1.axhline(y=reference, linestyle='--', label='Reference', color='k')
    ax1.legend()
    plt.savefig(f'{outdir}/difftre_kappa_history_' + model + str(visible_device) + '.png')
    return

def plot_cp_history(prediction_history, model, visible_device, reference=None,  outdir="./figures"):
    fig, ax1 = plt.subplots()
    ax1.set_xlabel('update step')
    ...
    if reference is not None:
        ax1.axhline(y=reference, linestyle='--', label='Reference', color='k')
    ax1.legend()
    plt.savefig(f'{outdir}/difftre_cp_history_' + model + str(visible_device) + '.png')
    return

def plot_loss_and_gradient_history(loss_history, visible_device,
                                   gradient_history=None,  outdir="./figures"):
    fig, ax1 = plt.subplots()
    color = 'tab:red'
    ax1.set_xlabel('update step')
    ax1.set_ylabel('Loss')
    ...
    plt.savefig(f'{outdir}/difftre_train_history' + str(visible_device) + '.png')
    return

def plot_entropy_history(predictions, visible_device, outdir="./figures"):
    fig, ax1 = plt.subplots()
    color = 'tab:red'
    ax1.set_xlabel('update step')
    ax1.set_ylabel('Entropy')
    for sim_key, preds in predictions.items():
        diff = [p['entropy'] for p in preds.values()]
        ax1.plot(diff, color=color, label=f'Statepoint {sim_key}')
    ax1.legend()
    plt.savefig(f'{outdir}/difftre_entropy_history' + str(visible_device) + '.png')
    return

def plot_free_energy_history(predictions, visible_device, outdir="./figures"):
    fig, ax1 = plt.subplots()
    color = 'tab:red'
    ax1.set_xlabel('update step')
    ax1.set_ylabel('Free Energy')
    for sim_key, preds in predictions.items():
        diff = [p['free_energy'] for p in preds.values()]
        ax1.plot(diff, color=color, label=f'Statepoint {sim_key}')
    ax1.legend()
    plt.savefig(f'{outdir}/difftre_free_energy_history' + str(visible_device) + '.png')
    return

def plot_and_save_tabulated_potential(x_vals, params, init_params, model, visible_device, outdir="./figures"):
    ...
    onp.savetxt(f'output/predicted_tabulated_potential_{visible_device}.csv', result_array)
    ...
    plt.ylim([-2.5, 5.])
    plt.legend()
    plt.savefig(f'{outdir}/difftre_predicted_Potential_' + model + str(visible_device) + '.png')
