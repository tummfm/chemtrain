...
from jax import vmap, random, numpy as jnp, tree_util
...
saved_params_path = 'output/rel_entropy/RE_LJ_2ns_4fs_150up_trained_params_alanine.pkl'
...
box, _, mass, _ = io.load_box(file_topology)
